...
!function(e){"function"==typeof define&&define.amd?define(["jquery"],e):e("object"==typeof exports?require("jquery"):jQuery)}(function(e){var t,n=navigator.userAgent,a=/iphone/i.test(n),i=/chrome/i.test(n),r=/android/i.test(n);e.mask={definitions:{9:"[0-9]",a:"[A-Za-z]","*":"[A-Za-z0-9]"},autoclear:!0,dataName:"rawMaskFn",placeholder:"_"},e.fn.extend({caret:function(e,t){var n;if(0!==this.length&&!this.is(":hidden"))return"number"==typeof e?(t="number"==typeof t?t:e,this.each(function(){this.setSelectionRange?this.setSelectionRange(e,t):this.createTextRange&&((n=this.createTextRange()).collapse(!0),n.moveEnd("character",t),n.moveStart("character",e),n.select())})):(this[0].setSelectionRange?(e=this[0].selectionStart,t=this[0].selectionEnd):document.selection&&document.selection.createRange&&(n=document.selection.createRange(),e=0-n.duplicate().moveStart("character",-1e5),t=e+n.text.length),{begin:e,end:t})},unmask:function(){return this.trigger("unmask")},mask:function(n,o){var c,l,u,f,s,h,g,m;if(!n&&this.length>0){var d=(c=e(this[0])).data(e.mask.dataName);return d?d():void 0}return o=e.extend({autoclear:e.mask.autoclear,placeholder:e.mask.placeholder,completed:null},o),l=e.mask.definitions,u=[],f=g=n.length,s=null,e.each(n.split(""),function(e,t){"?"==t?(g--,f=e):l[t]?(u.push(new RegExp(l[t])),null===s&&(s=u.length-1),f>e&&(h=u.length-1)):u.push(null)}),this.trigger("unmask").each(function(){function c(){if(o.completed){for(var e=s;h>=e;e++)if(u[e]&&R[e]===d(e))return;o.completed.call(j)}}function d(e){return o.placeholder.charAt(e<o.placeholder.length?e:0)}function p(e){for(;++e<g&&!u[e];);return e}function v(e,t){var n,a;if(!(0>e)){for(n=e,a=p(t);g>n;n++)if(u[n]){if(!(g>a&&u[n].test(R[a])))break;R[n]=R[a],R[a]=d(a),a=p(a)}y(),j.caret(Math.max(s,e))}}function b(){x(),j.val()!=A&&j.change()}function k(e,t){var n;for(n=e;t>n&&g>n;n++)u[n]&&(R[n]=d(n))}function y(){j.val(R.join(""))}function x(e){var t,n,a,i=j.val(),r=-1;for(t=0,a=0;g>t;t++)if(u[t]){for(R[t]=d(t);a++<i.length;)if(n=i.charAt(a-1),u[t].test(n)){R[t]=n,r=t;break}if(a>i.length){k(t+1,g);break}}else R[t]===i.charAt(a)&&a++,f>t&&(r=t);return e?y():f>r+1?o.autoclear||R.join("")===S?(j.val()&&j.val(""),k(0,g)):y():(y(),j.val(j.val().substring(0,r+1))),f?t:s}var j=e(this),R=e.map(n.split(""),function(e,t){return"?"!=e?l[e]?d(t):e:void 0}),S=R.join(""),A=j.val();j.data(e.mask.dataName,function(){return e.map(R,function(e,t){return u[t]&&e!=d(t)?e:null}).join("")}),j.one("unmask",function(){j.off(".mask").removeData(e.mask.dataName)}).on("focus.mask",function(){if(!j.prop("readonly")){clearTimeout(t);var e;A=j.val(),e=x(),t=setTimeout(function(){j.get(0)===document.activeElement&&(y(),e==n.replace("?","").length?j.caret(0,e):j.caret(e))},10)}}).on("blur.mask",b).on("keydown.mask",function(e){if(!j.prop("readonly")){var t,n,i,r=e.which||e.keyCode;m=j.val(),8===r||46===r||a&&127===r?(t=j.caret(),n=t.begin,(i=t.end)-n==0&&(n=46!==r?function(e){for(;--e>=0&&!u[e];);return e}(n):i=p(n-1),i=46===r?p(i):i),k(n,i),v(n,i-1),e.preventDefault()):13===r?b.call(this,e):27===r&&(j.val(A),j.caret(0,x()),e.preventDefault())}}).on("keypress.mask",function(t){if(!j.prop("readonly")){var n,a,i,o=t.which||t.keyCode,l=j.caret();t.ctrlKey||t.altKey||t.metaKey||32>o||!o||13===o||(l.end-l.begin!=0&&(k(l.begin,l.end),v(l.begin,l.end-1)),n=p(l.begin-1),g>n&&(a=String.fromCharCode(o),u[n].test(a))&&(function(e){var t,n,a,i;for(t=e,n=d(e);g>t;t++)if(u[t]){if(a=p(t),i=R[t],R[t]=n,!(g>a&&u[a].test(i)))break;n=i}}(n),R[n]=a,y(),i=p(n),r?setTimeout(function(){e.proxy(e.fn.caret,j,i)()},0):j.caret(i),l.begin<=h&&c()),t.preventDefault())}}).on("input.mask paste.mask",function(){j.prop("readonly")||setTimeout(function(){var e=x(!0);j.caret(e),c()},0)}),i&&r&&j.off("input.mask").on("input.mask",function(){var e=j.val(),t=j.caret();if(m&&m.length&&m.length>e.length){for(x(!0);t.begin>0&&!u[t.begin-1];)t.begin--;if(0===t.begin)for(;t.begin<s&&!u[t.begin];)t.begin++;j.caret(t.begin,t.begin)}else{for(x(!0);t.begin<g&&!u[t.begin];)t.begin++;j.caret(t.begin,t.begin)}c()}),x()})}})});
!function(e){"function"==typeof define&&define.amd&&define.amd.jQuery?define(["jquery"],e):e("undefined"!=typeof module&&module.exports?require("jquery"):jQuery)}(function(e){"use strict";var n="left",t="right",r="up",i="down",l="in",o="out",a="none",u="auto",s="swipe",c="pinch",p="tap",h="doubletap",f="longtap",d="horizontal",g="vertical",w="all",v=10,T="start",b="move",y="end",E="cancel",m="ontouchstart"in window,x=window.navigator.msPointerEnabled&&!window.navigator.pointerEnabled&&!m,S=(window.navigator.pointerEnabled||window.navigator.msPointerEnabled)&&!m,O="TouchSwipe";e.fn.swipe=function(M){var D=e(this),P=D.data(O);if(P&&"string"==typeof M){if(P[M])return P[M].apply(P,Array.prototype.slice.call(arguments,1));e.error("Method "+M+" does not exist on jQuery.swipe")}else if(P&&"object"==typeof M)P.option.apply(P,arguments);else if(!(P||"object"!=typeof M&&M))return function(M){return!M||void 0!==M.allowPageScroll||void 0===M.swipe&&void 0===M.swipeStatus||(M.allowPageScroll=a),void 0!==M.click&&void 0===M.tap&&(M.tap=M.click),M||(M={}),M=e.extend({},e.fn.swipe.defaults,M),this.each(function(){var D=e(this),P=D.data(O);P||(P=new function(M,D){function P(l){if(!0!==me.data(O+"_intouch")&&!(e(l.target).closest(D.excludedElements,me).length>0)){var o=l.originalEvent?l.originalEvent:l;if(!o.pointerType||"mouse"!=o.pointerType||0!=D.fallbackToMouseEvents){var a,u=o.touches,s=u?u[0]:o;return xe=T,u?Se=u.length:!1!==D.preventDefaultEvents&&l.preventDefault(),he=0,fe=null,de=null,ye=null,ge=0,we=0,ve=0,Te=1,be=0,Ee=function(){var e={};return e[n]=ne(n),e[t]=ne(t),e[r]=ne(r),e[i]=ne(i),e}(),Z(),K(0,s),!u||Se===D.fingers||D.fingers===w||C()?(Me=le(),2==Se&&(K(1,u[1]),we=ve=re(Oe[0].start,Oe[1].start)),(D.swipeStatus||D.pinchStatus)&&(a=j(o,xe))):a=!1,!1===a?(xe=E,j(o,xe),a):(D.hold&&(Ae=setTimeout(e.proxy(function(){me.trigger("hold",[o.target]),D.hold&&(a=D.hold.call(me,o,o.target))},this),D.longTapThreshold)),J(!0),null)}}}function L(s){var c=s.originalEvent?s.originalEvent:s;if(xe!==y&&xe!==E&&!B()){var p,h=c.touches,f=$(h?h[0]:c);if(De=le(),h&&(Se=h.length),D.hold&&clearTimeout(Ae),xe=b,2==Se&&(0==we?(K(1,h[1]),we=ve=re(Oe[0].start,Oe[1].start)):($(h[1]),ve=re(Oe[0].end,Oe[1].end),Oe[0].end,Oe[1].end,ye=Te<1?o:l),Te=(ve/we*1).toFixed(2),be=Math.abs(we-ve)),Se===D.fingers||D.fingers===w||!h||C()){if(fe=ie(f.start,f.end),de=ie(f.last,f.end),function(e,l){if(!1!==D.preventDefaultEvents)if(D.allowPageScroll===a)e.preventDefault();else{var o=D.allowPageScroll===u;switch(l){case n:(D.swipeLeft&&o||!o&&D.allowPageScroll!=d)&&e.preventDefault();break;case t:(D.swipeRight&&o||!o&&D.allowPageScroll!=d)&&e.preventDefault();break;case r:(D.swipeUp&&o||!o&&D.allowPageScroll!=g)&&e.preventDefault();break;case i:(D.swipeDown&&o||!o&&D.allowPageScroll!=g)&&e.preventDefault()}}}(s,de),he=function(e,n){return Math.round(Math.sqrt(Math.pow(n.x-e.x,2)+Math.pow(n.y-e.y,2)))}(f.start,f.end),ge=te(),function(e,n){e!=a&&(n=Math.max(n,ee(e)),Ee[e].distance=n)}(fe,he),p=j(c,xe),!D.triggerOnTouchEnd||D.triggerOnTouchLeave){var v=!0;if(D.triggerOnTouchLeave){var T=function(n){var t=(n=e(n)).offset();return{left:t.left,right:t.left+n.outerWidth(),top:t.top,bottom:t.top+n.outerHeight()}}(this);v=function(e,n){return e.x>n.left&&e.x<n.right&&e.y>n.top&&e.y<n.bottom}(f.end,T)}!D.triggerOnTouchEnd&&v?xe=U(b):D.triggerOnTouchLeave&&!v&&(xe=U(y)),xe!=E&&xe!=y||j(c,xe)}}else xe=E,j(c,xe);!1===p&&(xe=E,j(c,xe))}}function R(e){var n=e.originalEvent?e.originalEvent:e,t=n.touches;if(t){if(t.length&&!B())return function(e){Pe=le(),Le=e.touches.length+1}(n),!0;if(t.length&&B())return!0}return B()&&(Se=Le),De=le(),ge=te(),_()||!H()?(xe=E,j(n,xe)):D.triggerOnTouchEnd||!1===D.triggerOnTouchEnd&&xe===b?(!1!==D.preventDefaultEvents&&!1!==e.cancelable&&e.preventDefault(),xe=y,j(n,xe)):!D.triggerOnTouchEnd&&W()?(xe=y,N(n,xe,p)):xe===b&&(xe=E,j(n,xe)),J(!1),null}function k(){Se=0,De=0,Me=0,we=0,ve=0,Te=1,Z(),J(!1)}function A(e){var n=e.originalEvent?e.originalEvent:e;D.triggerOnTouchLeave&&(xe=U(y),j(n,xe))}function I(){me.unbind(ae,P),me.unbind(pe,k),me.unbind(ue,L),me.unbind(se,R),ce&&me.unbind(ce,A),J(!1)}function U(e){var n=e,t=q(),r=H(),i=_();return!t||i?n=E:!r||e!=b||D.triggerOnTouchEnd&&!D.triggerOnTouchLeave?!r&&e==y&&D.triggerOnTouchLeave&&(n=E):n=y,n}function j(e,n){var t,r=e.touches;return(!(!F()||!X())||X())&&(t=N(e,n,s)),(!(!Q()||!C())||C())&&!1!==t&&(t=N(e,n,c)),G()&&z()&&!1!==t?t=N(e,n,h):ge>D.longTapThreshold&&he<v&&D.longTap&&!1!==t?t=N(e,n,f):!(1!==Se&&m||!(isNaN(he)||he<D.threshold)||!W())&&!1!==t&&(t=N(e,n,p)),n===E&&k(),n===y&&(r?r.length||k():k()),t}function N(a,u,d){var g;if(d==s){if(me.trigger("swipeStatus",[u,fe||null,he||0,ge||0,Se,Oe,de]),D.swipeStatus&&!1===(g=D.swipeStatus.call(me,a,u,fe||null,he||0,ge||0,Se,Oe,de)))return!1;if(u==y&&F()){if(clearTimeout(ke),clearTimeout(Ae),me.trigger("swipe",[fe,he,ge,Se,Oe,de]),D.swipe&&!1===(g=D.swipe.call(me,a,fe,he,ge,Se,Oe,de)))return!1;switch(fe){case n:me.trigger("swipeLeft",[fe,he,ge,Se,Oe,de]),D.swipeLeft&&(g=D.swipeLeft.call(me,a,fe,he,ge,Se,Oe,de));break;case t:me.trigger("swipeRight",[fe,he,ge,Se,Oe,de]),D.swipeRight&&(g=D.swipeRight.call(me,a,fe,he,ge,Se,Oe,de));break;case r:me.trigger("swipeUp",[fe,he,ge,Se,Oe,de]),D.swipeUp&&(g=D.swipeUp.call(me,a,fe,he,ge,Se,Oe,de));break;case i:me.trigger("swipeDown",[fe,he,ge,Se,Oe,de]),D.swipeDown&&(g=D.swipeDown.call(me,a,fe,he,ge,Se,Oe,de))}}}if(d==c){if(me.trigger("pinchStatus",[u,ye||null,be||0,ge||0,Se,Te,Oe]),D.pinchStatus&&!1===(g=D.pinchStatus.call(me,a,u,ye||null,be||0,ge||0,Se,Te,Oe)))return!1;if(u==y&&Q())switch(ye){case l:me.trigger("pinchIn",[ye||null,be||0,ge||0,Se,Te,Oe]),D.pinchIn&&(g=D.pinchIn.call(me,a,ye||null,be||0,ge||0,Se,Te,Oe));break;case o:me.trigger("pinchOut",[ye||null,be||0,ge||0,Se,Te,Oe]),D.pinchOut&&(g=D.pinchOut.call(me,a,ye||null,be||0,ge||0,Se,Te,Oe))}}return d==p?u!==E&&u!==y||(clearTimeout(ke),clearTimeout(Ae),z()&&!G()?(Re=le(),ke=setTimeout(e.proxy(function(){Re=null,me.trigger("tap",[a.target]),D.tap&&(g=D.tap.call(me,a,a.target))},this),D.doubleTapThreshold)):(Re=null,me.trigger("tap",[a.target]),D.tap&&(g=D.tap.call(me,a,a.target)))):d==h?u!==E&&u!==y||(clearTimeout(ke),clearTimeout(Ae),Re=null,me.trigger("doubletap",[a.target]),D.doubleTap&&(g=D.doubleTap.call(me,a,a.target))):d==f&&(u!==E&&u!==y||(clearTimeout(ke),Re=null,me.trigger("longtap",[a.target]),D.longTap&&(g=D.longTap.call(me,a,a.target)))),g}function H(){var e=!0;return null!==D.threshold&&(e=he>=D.threshold),e}function _(){var e=!1;return null!==D.cancelThreshold&&null!==fe&&(e=ee(fe)-he>=D.cancelThreshold),e}function q(){return!(D.maxTimeThreshold&&ge>=D.maxTimeThreshold)}function Q(){var e=Y(),n=V(),t=null===D.pinchThreshold||be>=D.pinchThreshold;return e&&n&&t}function C(){return!!(D.pinchStatus||D.pinchIn||D.pinchOut)}function F(){var e=q(),n=H(),t=Y(),r=V();return!_()&&r&&t&&n&&e}function X(){return!!(D.swipe||D.swipeStatus||D.swipeLeft||D.swipeRight||D.swipeUp||D.swipeDown)}function Y(){return Se===D.fingers||D.fingers===w||!m}function V(){return 0!==Oe[0].end.x}function W(){return!!D.tap}function z(){return!!D.doubleTap}function G(){if(null==Re)return!1;var e=le();return z()&&e-Re<=D.doubleTapThreshold}function Z(){Pe=0,Le=0}function B(){var e=!1;return Pe&&le()-Pe<=D.fingerReleaseThreshold&&(e=!0),e}function J(e){me&&(!0===e?(me.bind(ue,L),me.bind(se,R),ce&&me.bind(ce,A)):(me.unbind(ue,L,!1),me.unbind(se,R,!1),ce&&me.unbind(ce,A,!1)),me.data(O+"_intouch",!0===e))}function K(e,n){var t={start:{x:0,y:0},last:{x:0,y:0},end:{x:0,y:0}};return t.start.x=t.last.x=t.end.x=n.pageX||n.clientX,t.start.y=t.last.y=t.end.y=n.pageY||n.clientY,Oe[e]=t,t}function $(e){var n=void 0!==e.identifier?e.identifier:0,t=function(e){return Oe[e]||null}(n);return null===t&&(t=K(n,e)),t.last.x=t.end.x,t.last.y=t.end.y,t.end.x=e.pageX||e.clientX,t.end.y=e.pageY||e.clientY,t}function ee(e){if(Ee[e])return Ee[e].distance}function ne(e){return{direction:e,distance:0}}function te(){return De-Me}function re(e,n){var t=Math.abs(e.x-n.x),r=Math.abs(e.y-n.y);return Math.round(Math.sqrt(t*t+r*r))}function ie(e,l){if(function(e,n){return e.x==n.x&&e.y==n.y}(e,l))return a;var o=function(e,n){var t=e.x-n.x,r=n.y-e.y,i=Math.atan2(r,t),l=Math.round(180*i/Math.PI);return l<0&&(l=360-Math.abs(l)),l}(e,l);return o<=45&&o>=0?n:o<=360&&o>=315?n:o>=135&&o<=225?t:o>45&&o<135?i:r}function le(){return(new Date).getTime()}var D=e.extend({},D),oe=m||S||!D.fallbackToMouseEvents,ae=oe?S?x?"MSPointerDown":"pointerdown":"touchstart":"mousedown",ue=oe?S?x?"MSPointerMove":"pointermove":"touchmove":"mousemove",se=oe?S?x?"MSPointerUp":"pointerup":"touchend":"mouseup",ce=oe?S?"mouseleave":null:"mouseleave",pe=S?x?"MSPointerCancel":"pointercancel":"touchcancel",he=0,fe=null,de=null,ge=0,we=0,ve=0,Te=1,be=0,ye=0,Ee=null,me=e(M),xe="start",Se=0,Oe={},Me=0,De=0,Pe=0,Le=0,Re=0,ke=null,Ae=null;try{me.bind(ae,P),me.bind(pe,k)}catch(n){e.error("events not supported "+ae+","+pe+" on jQuery.swipe")}this.enable=function(){return this.disable(),me.bind(ae,P),me.bind(pe,k),me},this.disable=function(){return I(),me},this.destroy=function(){I(),me.data(O,null),me=null},this.option=function(n,t){if("object"==typeof n)D=e.extend(D,n);else if(void 0!==D[n]){if(void 0===t)return D[n];D[n]=t}else{if(!n)return D;e.error("Option "+n+" does not exist on jQuery.swipe.options")}return null}}(this,M),D.data(O,P))})}.apply(this,arguments);return D},e.fn.swipe.version="1.6.18",e.fn.swipe.defaults={fingers:1,threshold:75,cancelThreshold:null,pinchThreshold:20,maxTimeThreshold:null,fingerReleaseThreshold:250,longTapThreshold:500,doubleTapThreshold:200,swipe:null,swipeLeft:null,swipeRight:null,swipeUp:null,swipeDown:null,swipeStatus:null,pinchIn:null,pinchOut:null,pinchStatus:null,click:null,tap:null,doubleTap:null,longTap:null,hold:null,triggerOnTouchEnd:!0,triggerOnTouchLeave:!1,allowPageScroll:"auto",fallbackToMouseEvents:!0,excludedElements:".noSwipe",preventDefaultEvents:!0},e.fn.swipe.phases={PHASE_START:T,PHASE_MOVE:b,PHASE_END:y,PHASE_CANCEL:E},e.fn.swipe.directions={LEFT:n,RIGHT:t,UP:r,DOWN:i,IN:l,OUT:o},e.fn.swipe.pageScroll={NONE:a,HORIZONTAL:d,VERTICAL:g,AUTO:u},e.fn.swipe.fingers={ONE:1,TWO:2,THREE:3,FOUR:4,FIVE:5,ALL:w}});
...
$(function(){function e(){var e=$(".slider__container");$(".slider__item").width(e.width())}var t=function(e,t){var n=e.find(".slider__item"),i=e.find(".slider__wrapper"),a=n.eq(t),o=a.index(),r=n.filter(".active");a.length&&i.animate({left:100*-o+"%"},500,function(){r.removeClass("active"),a.addClass("active")})},n=$(".wrapper"),i=$(".section"),a=$(".main-content"),o=!1;i.first().addClass("active"),e();var r=function(e){if(!o){o=!0;var t=-100*e+"%";a.css({transform:"translateY("+t+")"}),$(".fixed-menu__item").eq(e).addClass("active").siblings().removeClass("active"),i.eq(e).addClass("active").siblings().removeClass("active"),setTimeout(function(){o=!1},100)}},c=function(e){return activeSection=e.filter(".active"),{activeSection:activeSection,nextSection:activeSection.next(),prevSection:activeSection.prev()}},l=function(e){var n=c(i),a=$(".slider__container"),o=a.find(".slider__item"),l=o.filter(".active"),s=l.next(),d=l.prev();"down"==e&&n.prevSection.length&&r(n.prevSection.index()),"up"==e&&n.nextSection.length&&r(n.nextSection.index()),"left"==e&&(s.length?t(a,s.index()):t(a,o.first().index())),"right"==e&&(d.length?t(a,d.index()):t(a,o.last().index()))};$(n).on({wheel:function(e){var t=e.originalEvent.deltaY;l(t>0?"up":"down")},touchmove:function(e){}}),$(document).on("keydown",function(e){var t=c(i);switch(e.keyCode){case 38:t.prevSection.length&&r(t.prevSection.index());break;case 40:t.nextSection.length&&r(t.nextSection.index())}}),$("[data-goto]").on("click",function(e){e.preventDefault();var t=$(e.target),n=parseInt(t.data("goto"));r(n);var i=$(".burger-nav"),a=$(".hamburger-menu-link"),o=$(".btn-close"),c=$(window).height();a.show(),o.hide(),i.animate({top:-1*c},500)}),$(window).swipe({swipe:function(e,t){l(t)},fallbackToMouseEvents:!1}),$(".hamburger-menu-link").on("click",function(e){e.preventDefault();var t=$(".burger-nav"),n=$(".hamburger-menu-link"),i=$(".btn-close"),a=$(window).height();t.css("top",-1*a),t.css("height",a),t.animate({top:"0"},500,function(){n.hide(),i.show()})}),$(".btn-close").on("click",function(e){e.preventDefault();var t=$(".burger-nav"),n=$(".hamburger-menu-link"),i=$(".btn-close"),a=$(window).height();n.show(),i.hide(),t.animate({top:-1*a},500)}),$(window).on("resize",function(){e(),$(window).height()<330?($("#form-name").attr("placeholder","Имя"),$("#form-phone").attr("placeholder","Телефон"),$("#form-street").attr("placeholder","Улица"),$("#form-house").attr("placeholder","Дом"),$("#form-housing").attr("placeholder","Корпус"),$("#form-flat").attr("placeholder","Квартира"),$("#form-floor").attr("placeholder","Этаж"),$("#form-comment").attr("placeholder","Комментарий")):($("#form-name").attr("placeholder",""),$("#form-phone").attr("placeholder",""),$("#form-street").attr("placeholder",""),$("#form-house").attr("placeholder",""),$("#form-housing").attr("placeholder",""),$("#form-flat").attr("placeholder",""),$("#form-floor").attr("placeholder",""),$("#form-comment").attr("placeholder",""))}),$(".arrow-scroll").on("click",function(e){e.preventDefault();var n=$(this),i=$(".slider__container"),a=i.find(".slider__item"),o=a.filter(".active"),r=o.next(),c=o.prev();n.hasClass("arrow-scroll_right")&&(r.length?t(i,r.index()):t(i,a.first().index())),n.hasClass("arrow-scroll_left")&&(c.length?t(i,c.index()):t(i,a.last().index()))}),$(".team-acco__item").on("click",function(e){e.preventDefault();var t=$(e.target).closest(".team-acco__item"),n=t.find(".team-acco__content"),i=t.find(".team-acco__avatar"),a=t.find(".team-acco__desc-occ"),o=t.find(".team-acco__desc-text"),r=t.siblings(),c=0;c=$(window).width()<769?i.outerHeight()+a.outerHeight()+o.outerHeight()+20:i.outerHeight(),t.hasClass("active")?(t.removeClass("active"),n.animate({height:"0"},300,function(){t.removeClass("active")})):(t.addClass("active"),r.removeClass("active"),n.animate({height:c+"px"},300,function(){r.removeClass("active"),t.addClass("active")}),r.find(".team-acco__content").animate({height:"0"},300))}),$(".menu-list__item").on("click",function(e){e.preventDefault();var t=$(e.target).closest(".menu-list__item"),n=t.find(".menu-list__title"),i=t.find(".menu-list__text"),a=t.siblings(),o=a.find(".menu-list__title"),r=a.find(".menu-list__text"),c=0;o.each(function(e,t){c+=$(t).outerWidth()}),(c=$(window).width()-(c+n.outerWidth()))>=540&&(c=540),t.hasClass("active")?i.animate({width:"0"},300,function(){t.removeClass("active")}):(i.animate({width:c+"px"},300,function(){a.removeClass("active"),t.addClass("active")}),r.animate({width:"0"},300))}),$(".modal__close").on("click",function(){var e=$(".modal__content"),t=$(".modal__wrapper");e.fadeOut(300),t.fadeOut(300)}),$(".review__btn").on("click",function(e){e.preventDefault();var t=$(e.target).closest(".reviews__hover-content"),n=t.find(".reviews__title"),i=t.find(".reviews__text-long"),a=$(".modal__content"),o=$(".modal__wrapper"),r=a.find(".modal__title"),c=a.find(".modal__text");r.text(n.text().trim()),c.text(i.text().trim()),o.fadeIn(500),a.fadeIn(500),a.css("display","flex")}),$(function(){var e=0;e=$(window).width()<769?$(window).width()<480?12:13:14,ymaps.ready(function(){t=new ymaps.Map("YMapsID",{center:[44.04261,43.049522],zoom:e}),i.forEach(function(e){n=new ymaps.Placemark([e.latitude,e.longitude],{hintContent:e.hintContent,hintContent:e.balloonContent},{iconLayout:"default#image",iconImageHref:"img/map-marker.svg",iconImageSize:[46,57],iconImageOffset:[-15,-50]}),t.geoObjects.add(n)}),t.behaviors.disable("scrollZoom").disable("drag")});var t,n,i=[{latitude:59.915038,longitude:30.486096,hintContent:"Mr.Burger на Товарищеском",balloonContent:"Товарищеский проспект, 20/27"},{latitude:44.044528,longitude:43.06431,hintContent:"Mr.Burger на проспекте",balloonContent:"проспект 40 лет Октября 57"},{latitude:44.043372,longitude:43.023357,hintContent:"Mr.Burger на Ермолова",balloonContent:"улица Ермолова 14/1"}]}),jQuery(function(e){e("#form-phone").mask("+7(999) 999-9999")}),$("#order-form").validate({rules:{name:{required:!0},street:{required:!0},phone:{required:!0},house:{required:!0}},focusCleanup:!0,focusInvalid:!1,errorPlacement:function(e,t){return!0},submitHandler:function(e){$.ajax({url:e.action,type:e.method,data:$(e).serialize(),success:function(t){if("1"==t){var n=$(".blur");n.css("filter","blur(50px)"),setTimeout(function(){var t=$(".order__success");t.fadeIn(500),t.css("display","flex"),setTimeout(function(){e.reset(),t.fadeOut(300),n.css("filter","none")},4e3)},1e3)}}})},errorClass:"form-input_error"})});